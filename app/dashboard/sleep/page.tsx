      ...
      >
        ...
        <div className="h-56">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={mergedSleep} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
              ...
              <Tooltip contentStyle={{ background: "rgba(15,23,42,0.95)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "12px" }} labelStyle={{ color: "rgba(255,255,255,0.6)", fontSize: 11 }} itemStyle={{ color: "#8b5cf6", fontSize: 12 }} />
